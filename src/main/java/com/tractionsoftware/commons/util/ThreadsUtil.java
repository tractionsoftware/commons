...
public final class ThreadsUtil {
    ...
    public static final boolean runInSeparateThreadWaitingForCompletion(Runnable task, int timeOut, TimeUnit timeOutUnit) {
        ...
        try {
            ...
            ObjectsUtil.getLogger()
                .log(Level.WARNING, "Thread interrupted while waiting for synchronous request completion.", e);
        }
        return false;
    ...
    public static final boolean tryToSleep(long millis) {
        try {
            ...
            ObjectsUtil.getLogger().log(Level.INFO, "Sleep interrupted", e);
        }
    ...
    public static final void tryToSetThreadName(Thread thread, String name) {
        try {
            ...
            ObjectsUtil.getLogger().log(Level.WARNING, "Failed to set name of Thread " + thread + " to " + name, e);
        }
    }
