...
public final class ObjectsUtil {
    ...
    /**
     * This default constructor is provided for Java bean compatibility only, and should not normally otherwise be used
     * since ObjectUtil does not have any instance fields or methods.
     */
    public ObjectsUtil() {
    }

    private static final String COMMONS_LOGGER_NAME = "com.tractionsoftware.commons";

    /**
     * Returns the "com.tractionsoftware.commons" {@link Logger}.
     *
     * @return the "com.tractionsoftware.commons" {@link Logger}.
     */
    public static final Logger getLogger() {
        return Logger.getLogger(COMMONS_LOGGER_NAME);
    }

    /**
     * Returns either the given value if it is not null, or a default value produced by the given {@link Supplier}.
     *
     * @param value
     *     the object to examine.
     * @param defaultSupplier
     *     a {@link Supplier} that can be used to produce a default value in case the given value is null.
     * @return the given value if it is not null; or a default value produced by the given {@link Supplier} otherwise.
     */
    public static final <T> T defaultIfNull(T value, Supplier<? extends T> defaultSupplier) {
        return defaultIfNotMatched(value, Objects::nonNull, defaultSupplier);
    }
     ...
     */
    public static final <T> T defaultIfNotMatched(T value, Predicate<? super T> matcher, Supplier<? extends T> defaultSupplier) {
     ...
     */
    public static final <T> T castIfAssignmentCompatible(Object value, Class<T> cls) {
        if (value == null) {
            return null;
        }
     ...
     */
    public static final int getCombinedHash(int hash, Object object) {
        hash *= 31;
        if (object != null) {
     ...
     *     value.
     */
    public static final String safeToString(Object object, String defaultValue) {
        try {
            ...
            getLogger().log(
                Level.WARNING,
                "There was an unexpected error converting an " + object.getClass().getName(),
                e
            );
        }
        return defaultValue;
     ...
     */
    public static final <E extends Enum<E>> E enumFromString(Class<E> enumType, String str, E defaultValue) {
     ...
     */
    public static final String[] safeToStringArray(Collection<?> coll) {
    ...
    public static final String[] toStringArray(Collection<?> coll, Function<Object,String> converter) {
    ...
    public static final void requireInstanceOf(Object value, Class<?> superType) {
        requireInstanceOf(value, superType, null);
    }

    public static final void requireInstanceOf(Object value, Class<?> superType, String message) {
