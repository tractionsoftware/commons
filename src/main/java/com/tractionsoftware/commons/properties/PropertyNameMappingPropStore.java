...
public final class PropertyNameMappingPropStore<R> extends AbstractPropertyNameMappingGetPutProperty<PropStore<R>> implements PropStore<R> {

    public static final <R> PropStore<R> wrapInNamespace(PropStore<R> props, String space) {
        return applyPropertyNameMapper(props, SimplePropertyNameMapper.getNamespaceInstanceWithDefaultSeparator(space));
    }

    public static final <R> PropStore<R> wrapInNamespace(PropStore<R> props, String space, char separator) {
        return applyPropertyNameMapper(props, SimplePropertyNameMapper.getNamespaceInstanceWithSeparator(space, separator));
    }

    public static final <R> PropStore<R> wrapInPrefix(PropStore<R> props, String space) {
        return applyPropertyNameMapper(props, SimplePropertyNameMapper.getPrefixInstanceWithDefaultSeparator(space));
    }

    public static final <R> PropStore<R> wrapInPrefix(PropStore<R> props, String space, char separator) {
        return applyPropertyNameMapper(props, SimplePropertyNameMapper.getPrefixInstanceWithSeparator(space, separator));
    }

    public static final <R> PropStore<R> applyPropertyNameMapper(PropStore<R> props, PropertyNameMapper nameMapper) {
        if (props == null || nameMapper == null) {
            return props;
        }
        if (props instanceof PropertyNameMappingPropStore<R> nameMappedProps) {
    ...
    public PropertyNameMappingPropStore(PropStore<R> props, PropertyNameMapper nameMapper) {
