...
/**
 * This generally represents a problem applying a {@link TextTransformer}'s transform method as a result of a limitation
 * of the TextTransformer's implementation.
 *
...
public class TextTransformationException extends Exception {
    ...
    @Serial
    private static final long serialVersionUID = -6449237266034789046L;

    /**
     * Constructs a new TransformationException with no detail message.
     */
    ...
    /**
     * Constructs a new TransformationException with the specified cause and a detail message of
