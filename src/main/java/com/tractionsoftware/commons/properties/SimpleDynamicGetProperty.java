...
/**
 * A simple implementation of {@link GetProperty} which uses a {@link Map} from {@link String} to any type, plus a
 * {@link Function} capable of mapping the Map's values to String for the {@link #getProperty(String)} method.
 *
 * <p>
 ...
 */
public final class SimpleDynamicGetProperty<V> implements GetProperty {

    /**
     * Creates a SimpleReadOnlyPropertyMap backed by a snapshot of the given {@link Map}'s name-value pairs.
     *
     * <p>
     * The values returned by the {@link #getProperty(String)} method will be exactly the values that are in the given
     * Map at the time this method is invoked (thus the "snapshot" aspect).
     *
     * @param properties
     ...
     */
    public static final SimpleDynamicGetProperty<String> ofSnapshottedStaticProperties(Map<String,String> properties) {
     ...
     *
     * <p>
     * The values returned by the {@link #getProperty(String)} method will be based upon the name-value pairs that are
     * in the given Map at the time the getValue method is invoked (i.e., not based upon a "snapshot" of the Map).
     *
     * @param properties
     *     a {@link Map} representing the static name-value pairs. It will be copied to an {@link ImmutableMap}.
     * @return a SimpleReadOnlyPropertyMap backed by the given {@link Map}'s name-value pairs.
     */
    public static final SimpleDynamicGetProperty<String> ofStaticProperties(Map<String,String> properties) {
     ...
     * @return a SimpleReadOnlyPropertyMap backed by a snapshot of the given {@link Map}'s name-value pairs.
     */
    public static final SimpleDynamicGetProperty<Supplier<String>> ofSnapshottedDynamicProperties(Map<String,? extends Supplier<String>> properties) {
     ...
     * {@link Supplier} Map values to produce {@link String}s for the {@link #getProperty(String)} method.
     *
     * <p>
     * The values returned by the {@link #getProperty(String)} method will be based upon the name-value pairs that are
     * in the given Map at the time the getValue method is invoked (i.e., not based upon a "snapshot" of the Map).
     ...
     * @return a SimpleReadOnlyPropertyMap backed by the given {@link Map}'s name-value pairs.
     */
    public static final SimpleDynamicGetProperty<Supplier<String>> ofDynamicProperties(Map<String,? extends Supplier<String>> properties) {
     ...
     *
     * <p>
     * The values returned by the {@link #getProperty(String)} method will be based upon exactly the values that are in
     * the given Map at the time this method is invoked (thus the "snapshot" aspect).
     *
     * @param properties
     *     a {@link Map} representing the static name-value pairs. It will be copied to an {@link ImmutableMap}.
     * @param evaluator
     ...
     * @return a SimpleReadOnlyPropertyMap backed by a snapshot of the given {@link Map}'s name-value pairs.
     */
    public static final <V> SimpleDynamicGetProperty<V> createSnapshotInstance(Map<String,? extends V> properties, Function<? super V,String> evaluator) {
        Objects.requireNonNull(properties, "properties Map");
        return new SimpleDynamicGetProperty<>(
     ...
     * {@link Function} to map the Map's values to {@link String}s for the {@link #getProperty(String)} method.
     *
     * <p>
     * The values returned by the {@link #getProperty(String)} method will be based upon the name-value pairs that are
     * in the given Map at the time the getValue method is invoked (i.e., not based upon a "snapshot" of the Map).
     ...
     * @return a SimpleReadOnlyPropertyMap backed by the given {@link Map}'s name-value pairs.
     */
    public static final <V> SimpleDynamicGetProperty<V> createInstance(Map<String,? extends V> properties, Function<? super V,String> evaluator) {
        Objects.requireNonNull(properties, "properties Map");
        return new SimpleDynamicGetProperty<>(Collections.unmodifiableMap(properties), evaluator);
    }
    ...
    private SimpleDynamicGetProperty(Map<String,? extends V> map, Function<? super V,String> evaluator) {
        this.map = map;
